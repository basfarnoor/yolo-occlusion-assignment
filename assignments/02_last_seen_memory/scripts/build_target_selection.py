...
is the student's job. See assignments/02_last_seen_memory/README.md.
"""
...
ASSIGNMENT_1_ROOT = ASSIGNMENT_ROOT.parent / "01_yolo_occlusion"
OCCLUDED_ROOT = ASSIGNMENT_1_ROOT / "occluded_samples"
DETECTIONS_CSV = ASSIGNMENT_1_ROOT / "results" / "all_detections.csv"
...
def main() -> None:
    ...
    for sample, stages in stages_by_sample.items():
        ...
        ws.append([
            ...
            STAGE_NAMES[stage_before], str(before_out.relative_to(ASSIGNMENT_ROOT)).replace("\\", "/"),
            STAGE_NAMES[stage_after], str(after_out.relative_to(ASSIGNMENT_ROOT)).replace("\\", "/"),
            "", "", "", "", "", "", "",
        ])
