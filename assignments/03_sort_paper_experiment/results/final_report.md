...
with IoU + Hungarian matching, manage track birth/death -- in educational Python (`experiment/src/`),
...
All 18 required automatic tests pass (`experiment/tests/`), covering: identical/non-overlapping
