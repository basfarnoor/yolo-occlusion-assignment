...
2016, arxiv.org/abs/1602.00763) -- see reuse_audit.md.
...
in this assignment reuses this cache instead of re-running YOLO. ByteTrack's
central claim depends on keeping low-score detections available, so this
assignment's confidence floor is set lower than Assignment 3's.
"""
