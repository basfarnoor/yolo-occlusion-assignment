...
2016, https://arxiv.org/abs/1602.00763) -- see reuse_audit.md. Both papers'
trackers represent a box's state as center position, scale (area), and aspect
ratio; this module converts between that representation and ordinary
(x1, y1, x2, y2) boxes.

Basic bounding-box geometry: the small building blocks every other module in
this experiment is built from.
"""
