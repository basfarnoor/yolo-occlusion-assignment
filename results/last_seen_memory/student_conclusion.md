...
*This directly motivates the next step in the bigger OATM research project (`TEMPORAL_OCCLUSION_METHODOLOGY.md`): ego-motion-compensated motion prediction instead of a static last-seen box.*
