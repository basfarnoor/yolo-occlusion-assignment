...
- The tracker, baseline, selection, evaluation, chart, and test code under
  [`../../sort_paper_experiment/`](../../sort_paper_experiment/)
...
- [`track_selection.py`](../../sort_paper_experiment/src/track_selection.py)
  stores `o.box`.
- [`sort_tracker.py`](../../sort_paper_experiment/src/sort_tracker.py) defines
